...
The ``domdf_sphinx_theme`` source code is available on GitHub,
...
The recommended way to build ``domdf_sphinx_theme`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
